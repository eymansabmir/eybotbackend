...
import type { IAnthropicIntegrationService } from '../../../plugins/anthropic';
...
export class AnthropicController {
  constructor(private readonly service: IAnthropicIntegrationService) {}
  ...
  listModels = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      // Ensure the credential is valid before listing models (optional but mirrors OpenAI)
